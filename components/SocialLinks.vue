<template>
    <div>
        <div class="social-links fixed bottom-2 right-2 bg-teal-800 bg-opacity-60 py-2 px-3 z-99999">
          <div class="grid grid-cols-3">
            ...
            <div class="col-span-2">
              <p class="text-xs text-center text-white">&copy; Ryo Fujiwara<br>All Rights Reserved</p>
            </div>
          </div>
        <!-- <ul>
          <li class="inline pr-5"><a href="https://github.com/rfujiwar23" class="text-white"><i class="text-2xl devicon-github-original"></i></a></li>
